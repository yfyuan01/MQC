...
first_retrieval_results = '/Users/yuanyifei/MQC_NEW/first_phase_retrieval/sample_runs/bm25.qrel'
qrels = '/Users/yuanyifei/MQC_NEW/mqc/data/facet/qrels'
train_qrels = '/Users/yuanyifei/MQC_NEW/facet_data/test.qrel'
facets = '/Users/yuanyifei/MQC_NEW/mqc/data/facet/facet_clip.csv'
all_records = '/Users/yuanyifei/MQC_NEW/first_phase_retrieval/Answer_data_clip.csv'
...
# all_records_json1 = []
for k,facet in enumerate(train_facet):
    record = {}
    # facet = a['facet_id']
...
with open('test_qpp_clip.json','w') as f:
