...
import pickle
from generative_retrieval_t5_data import get_loader
...
from trainer_base_1 import TrainerBase
...
class Trainer(TrainerBase):
    def __init__(self, args, train_loader=None, val_loader=None, test_loader=None, train=True):
        ...
        from generative_retrieval_t5_model import T5GR, BartGR
    ...
    def train(self):
        if self.verbose:
            ...
            if not self.wandb_initialized:
                ...
                if 't5' in self.args.backbone:
                    project_name = "T5_GenerativeRetrieval"
                elif 'bart' in self.args.backbone:
                    project_name = "Bart_GenerativeRetrieval"
        ...
        for epoch in range(epochs):
            ...
            if self.verbose:
                ...
                log_str += "\nEpoch %d: Valid P@5 %0.4f" % (epoch, valid_score)
                log_str += "\nEpoch %d: Best P@5 %0.4f\n" % (best_epoch, best_valid)
