...
vg_dir = dataset_dir
img_dir = '../../img_features/img_feature_all.pkl'
...
class GRFineTuneDataset(Dataset):
    def __init__(self, split='train', raw_dataset=None, rank=-1, topk=-1, verbose=True, args=None, mode='train'):
        ...
        if self.args.max_n_boxes == 36:
            ...
            self.img_feature_dict = pickle.load(open(img_dir,'rb'))
    ...
    def __getitem__(self, idx):
        ...
        if self.args.use_vision:
            ...
            # out_dict['boxes'] = out_dict['boxes'][0]
            # out_dict['vis_feats'] = out_dict['vis_feats'][0]
        ...
        if datum['is_train']:
            ...
            targets = out_dict['targets'].strip()
            if 't5' in self.args.tokenizer:
    ...
    def collate_fn(self, batch):
        ...
        if self.args.use_vision:
            ...
            tags = torch.zeros(B,1,dtype=torch.float)
...
class GREvaluator:
    ...
    def evaluate(self, predicts, answers):
        ...
        results = {'P@1':p1,'P@3':p3,'P@5':p5,'P@10':p10}
