...
# query_tok: batch_size*max_len | doc_tok: batch_size * max_doc (if exceed 512 then subbatch)
    ...
    def encode_bert(self, query_tok, query_mask, doc_tok, doc_mask):
        ...
        #the function of modeling_util is to deal with the 512 token limit of the document
